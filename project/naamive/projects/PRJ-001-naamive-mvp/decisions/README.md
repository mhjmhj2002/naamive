# PRJ-001 — Decision Records

- `DEC-001_BOOTSTRAP_STATE_RECONCILIATION.md` — corrects invalid bootstrap projection/currentness claims without fabricating transitions.
- `DEC-002_TIR_LIFECYCLE_PRECEDENCE.md` — TIR is technical readiness, not lifecycle/Execution authority.
- `DEC-003_PROJECT_READ_SOURCE.md` — candidate canonical read-only Project source contract, implemented by WI-013.
- `DEC-004_ACTIVITY_CENTER_PROJECTION_CONTRACT.md` — candidate source/rebuild/invalidation contract for WI-010/011.
