...
| RM-003 | WORK_ITEM | WI-001 | CR-WI001-01 FAIL; WI-001 IN_REVIEW; próxima ação: governed rework for F001–F004, then authorized review/acceptance |
...
`CR-WI001-01` retornou FAIL com quatro findings BLOCKING; a próxima ação legítima é governed rework, seguida de nova review/aceite autorizados, sem promover automaticamente `WI-001` para `DONE`.
