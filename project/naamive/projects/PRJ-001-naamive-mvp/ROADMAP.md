...
| RM-003 | WORK_ITEM | WI-001 | EX-002 SUCCEEDED; remediação F001–F005 aguarda CR-WI001-02 independente e acceptance separado |
...
histórica e `EX-002 SUCCEEDED`. A próxima ação legítima é `CR-WI001-02`, nova
review independente, sem promover automaticamente `WI-001` para `DONE`.
