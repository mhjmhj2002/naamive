...
| RM-003 | WORK_ITEM | WI-001 | CR-WI001-02 FAIL; rework governado de F003/F004 requerido antes de nova review e acceptance separado |
...
Permanecem 12 PROPOSED / 1 IN_REVIEW; 1 Development Cycle; `EX-001` é
histórica e `EX-002 SUCCEEDED`. `CR-WI001-02` retornou `FAIL`; a próxima ação
legítima é rework governado de F003/F004, sem promover automaticamente
`WI-001` para `DONE`.
