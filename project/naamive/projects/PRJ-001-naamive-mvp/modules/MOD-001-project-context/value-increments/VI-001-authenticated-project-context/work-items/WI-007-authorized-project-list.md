# WI-007 — Authorized Project List
...
**Depends on:** WI-005, WI-006, WI-013  
...
List only canonical Projects visible to the current principal.

## Out of scope

Project lifecycle mutation; dedicated search projection before measurement; Activity Center projection.

## Dependency satisfaction condition

WI-005, WI-006 and WI-013 = DONE; authority and canonical Project query contracts available.
...
- GET /api/projects
- server-side authority revalidation
- unauthorized Projects hidden
- pagination/search contract without premature read model
- allowed/denied coverage

## Required tests

- allowed Projects returned from canonical Project source
- unauthorized Project omitted even if known by ID
- server revalidates grant on query
- pagination/search contract is deterministic
- revoked grant disappears after restart/refetch

## Required evidence

- API integration tests with allowed/denied Projects
- query contract tests
- restart/revocation list evidence
