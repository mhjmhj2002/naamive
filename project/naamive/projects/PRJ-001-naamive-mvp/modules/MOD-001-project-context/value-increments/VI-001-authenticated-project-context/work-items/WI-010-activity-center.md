# WI-010 — Initial Activity Center Projection
...
**Depends on:** WI-008, WI-009, WI-013  
...
Provide a factual, rebuildable Activity Center projection for the selected Project.

## Out of scope

Canonical business mutation; log-as-truth; Execution Board as projection source; realtime transport behavior.

## Dependency satisfaction condition

WI-008, WI-009 and WI-013 = DONE; DEC-004 source contract still valid.
...
- projection.activity_center exists
- source/watermark traceable
- projection != canonical truth
- current state separate from timeline/history
- no fake progress
- GET /api/projects/:projectId/activity

## Required tests

- projection rows retain source_ref/source_version/watermark
- rebuild from declared canonical sources is deterministic/idempotent
- projection can be discarded/recreated after restart
- current view remains distinguishable from timeline/history
- undeclared logs/board/browser data cannot become source
- staleness/watermark is observable

## Required evidence

- projection integration/rebuild test outputs
- source/watermark fixtures and assertions
