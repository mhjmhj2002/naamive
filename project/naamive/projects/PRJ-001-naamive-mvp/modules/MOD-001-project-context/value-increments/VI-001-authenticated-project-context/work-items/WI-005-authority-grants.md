# WI-005 — Authority / Scoped Grants
...
Apply AuthorityService and durable Project-scoped grants for server-side authorization.

## Out of scope

Canonical Project persistence itself; Project UI rendering; lifecycle mutation.

## Dependency satisfaction condition

WI-002 = DONE and WI-004 = DONE on compatible baseline; principal/session identities stable.
...
- grant durable and revocable
- out-of-scope Project denied
- session != authority
- revocation restart-safe
- material audit/history preserved

## Required tests

- allowed grant permits exact Project scope
- missing/wrong/revoked grant denies access
- session existence never substitutes grant authority
- grant revocation remains effective after restart
- material grant/history records remain reconstructible

## Required evidence

- AuthorityService unit/application tests
- PostgreSQL grant/history integration outputs
- restart/revocation authorization evidence
