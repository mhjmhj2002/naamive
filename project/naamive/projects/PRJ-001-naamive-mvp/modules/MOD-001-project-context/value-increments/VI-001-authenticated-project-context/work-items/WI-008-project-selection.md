# WI-008 — Explicit Project Selection
...
Select an authorized Project explicitly through a navigable canonical context.

## Out of scope

Project mutation; browser-local canonical state; Activity Center projection.

## Dependency satisfaction condition

WI-007 = DONE; authorized canonical Project list/query contract stable.
...
- URL is navigable context
- GET /api/projects/:projectId
- server-side denial without grant
- selection not dependent only on browser state

## Required tests

- deep link /projects/:projectId loads allowed Project after refresh
- unauthorized Project route denied server-side
- changing Project updates navigable URL/context
- browser local state cannot bypass server authority
- missing Project produces deterministic not-found/forbidden behavior

## Required evidence

- router/UI behavior tests
- API authorization tests
- refresh/deep-link E2E evidence
