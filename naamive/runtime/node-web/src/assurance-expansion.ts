...
export const reserveAssuranceDispatch=async(client:pg.PoolClient,input:DispatchInput)=>{
  ...
  if(!line||line.subject!==input.subjectKind||!line.selectable)throw new AssuranceError(line?'ASSURANCE_INTERNAL_JOB_NOT_SELECTABLE':'ASSURANCE_JOB_NOT_IN_NORMATIVE_MATRIX');
