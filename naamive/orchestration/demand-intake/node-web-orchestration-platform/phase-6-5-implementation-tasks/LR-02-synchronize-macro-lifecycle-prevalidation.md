...
- contratos LR-01, GAT-01, GAT-03, AUT-01 e REC-01, inclusive suas
  pré-validações;
- `workflow.ts`, `service.ts`, `phase3.ts`, `baseline-revision.ts`,
  `eligibility-scheduler.ts`, `recovery.ts`, `reconcile.ts`, `projection.ts`,
  `server.ts`, `worker.ts` e `discovery-agent-jobs.ts`;
- migrations 005, 006, 016--021, 029, 048--060 e os testes
  `workflow-v3.e2e.test.ts`, `lifecycle-v2.e2e.test.ts` e `phase3.e2e.test.ts`.
