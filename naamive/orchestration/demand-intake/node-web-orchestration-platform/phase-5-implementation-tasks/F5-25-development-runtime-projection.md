...
2. [ ] **DOING:** Criar um projetor backend que seleciona tentativa por `delivery.id`: duas ou
...
3. [ ] **DOING:** Publicar exclusivamente `development-runtime/v1`: IDs, estados
...
4. [ ] **DOING:** Implementar uma matriz de projeção versionada e fechada. Ela inclui
...
5. [ ] **DOING:** Executar o detector fora de requisições GET e, em transação de inserção pura,
