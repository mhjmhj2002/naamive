...
Se identificar fronteira estruturalmente errada, não redefine silenciosamente o conjunto de Módulos: devolve o problema ao Especialista em Delimitação de Módulos. Não audita, não cria Entregas de Valor, Itens de Trabalho ou tarefas, e não implementa software.
